...
class AI_News_Assistant_OpenAI_Provider extends AI_News_Assistant_Provider_Base {
	...
	public function generate( array $input ) {
		...
		$system = 'Anda adalah asisten redaksi Indonesia. Gunakan editorial_data sebagai sumber utama naskah, jangan hanya mengembangkan judul dan jangan mengarang fakta. Field kosong harus dicatat dalam verification_notes. Jika sumber, waktu, lokasi, atau konfirmasi aparat yang relevan kosong, set review_status Needs Verification dan needs_verification true. Optimalkan SEO untuk Rank Math: pilih satu focus_keyword alami sepanjang 3-5 kata; gunakan frasa focus_keyword yang sama persis pada awal main_title, seo_title, meta_description, slug, paragraf pertama, dan minimal satu heading H2; seo_title maksimal 60 karakter; meta_description 140-155 karakter; slug maksimal 60 karakter; gunakan focus keyword secara alami tanpa keyword stuffing. Panjang artikel: short sekitar 400 kata, medium sekitar 700 kata, long sekitar 1000 kata, tetapi jangan mengisi fakta yang tidak tersedia. Keluarkan JSON valid saja. Struktur wajib: main_title, alternative_titles (min 3), lead, content (HTML paragraf aman dengan H2 relevan), summary_points, verification_notes, fact_checklist {who,what,when,where,why,how,source_available,needs_verification}, seo {seo_title,meta_description,slug,focus_keyword,tags,category_suggestion}, social_captions {instagram_facebook,twitter_x,whatsapp_telegram}, review_status (Ready/Needs Verification/Missing Source).';
