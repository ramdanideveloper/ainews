...
class AiController extends ApiController
{
    ...
    {
        $payload = $r->validate(['title' => 'nullable|string|max:500', 'payload' => 'nullable|array', 'payload.length' => 'nullable|integer|min:200|max:900', 'content' => 'nullable|string|max:100000', 'editorial_data' => 'nullable|array']);
