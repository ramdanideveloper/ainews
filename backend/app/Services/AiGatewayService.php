...
class AiGatewayService
{
    ...
    private function articleExpansionMessages(array $payload, array $draft, int $target, int $actual): array
    {
        ...
        $pointTarget = $structure !== 'standard' ? $this->articlePointTarget($payload) : null;
        $structureRule = $pointTarget ? " Pertahankan tepat {$pointTarget} poin dengan format {$structure}; jangan menambah, menghapus, memecah, atau menggabungkan poin. Berikan penjelasan substantif sekitar 100 kata (90-110 kata) pada setiap poin." : '';
    ...
    private function articleStructureCorrectionMessages(array $payload, array $draft, string $structure, int $target, int $actual): array
    {
        $format = match ($structure) {
            'faq' => 'Gunakan tepat '.$target.' elemen <section class="aina-faq-item"><h2>Pertanyaan</h2><p>Jawaban sekitar 100 kata (90-110 kata).</p></section>.',
            'tutorial' => 'Gunakan satu <ol class="aina-article-points"> dengan tepat '.$target.' elemen <li>. Setiap li adalah satu langkah dengan penjelasan sekitar 100 kata (90-110 kata) dan tidak boleh berisi daftar bertingkat.',
            default => 'Gunakan satu <ol class="aina-article-points"> dengan tepat '.$target.' elemen <li>. Setiap li adalah satu ide berbeda dengan penjelasan sekitar 100 kata (90-110 kata) dan tidak boleh berisi daftar bertingkat.',
        };
